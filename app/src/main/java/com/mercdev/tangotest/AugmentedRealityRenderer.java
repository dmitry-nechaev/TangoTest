...
public class AugmentedRealityRenderer extends Renderer {
	...
	private boolean isWallsVisible = true;
	...
	protected void initScene() {
		...
		if (fixtures != null && isFixturesVisible) {
			for (Fixture fixture : fixtures) {
				...
				rect.setName(fixture.toString(getContext().getResources()));
	...
	public void switchFixturesVisibility() {
		isFixturesVisible = !isFixturesVisible;
		for (Object3D object : objects) {
			if (object instanceof FixtureRectangularPrism && ((FixtureRectangularPrism) object).getType() == Fixture.Type.Wall) {
				object.setVisible(isWallsVisible && isFixturesVisible);
			} else {
	...
	public void switchWallsVisibility() {
		isWallsVisible = !isWallsVisible;
		for (Object3D object : objects) {
			if (object instanceof FixtureRectangularPrism && ((FixtureRectangularPrism) object).getType() == Fixture.Type.Wall) {
				object.setVisible(isWallsVisible);
			}
		}
	}
